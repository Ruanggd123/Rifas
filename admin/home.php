...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <h2 class="my-6 text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400 dark:from-indigo-400 dark:to-purple-400 animate-fade-in" style="margin-bottom: 2rem;">
            Central de Comando do <?php echo $_settings->info('name'); ?>!
        </h2>
