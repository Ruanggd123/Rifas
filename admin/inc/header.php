...
echo "\r\n" .
    ...
    '                href="./">' .
    "\r\n" .
    '<i class="fa-solid w-6 fa-house text-lg"></i>' .
    "\r\n" .
    ...
    '                href="./?page=products">' .
    "\r\n" .
    '<i class="fa-solid w-6 fa-table-list text-lg"></i>' .
    "\r\n" .
    ...
    '                href="./?page=orders">' .
    "\r\n" .
   '<i class="fa-solid w-6 fa-cart-shopping text-lg"></i>' .
    "\r\n" .
    ...
    '                href="./?page=report">' .
    "\r\n" .
		'<i class="fa-solid w-6 fa-chart-simple text-lg"></i>' .
    "\r\n" .
    ...
    '                href="./?page=ranking">' .
    "\r\n\r\n" .
   '<i class="fa-solid w-6 fa-trophy text-lg"></i>' .
    "\r\n" .
    ...
    '                href="./?page=customers">' .
    "\r\n" .
   '<i class="fa-solid w-6 fa-folder-open text-lg"></i>' .
    "\r\n" .
    ...
    "\r\n" .
   '<i class="fa-solid w-6 fa-users text-lg"></i>' .
    "\r\n" .
   ...
   '<i class="fa-brands fa-pix text-lg"></i>' .
    ...
    "\r\n" .
   '<i class="fa-solid w-6 fa-gear text-lg "></i>' .
    "\r\n" .
...
' .
  ...
  '<i class="fa-brands fa-pix text-lg"></i>' .
    ...
    '              href="./?page=system_info">' .
    "\r\n" .
   '<i class="fa-solid w-6 fa-gear text-lg mr-4"></i>' .
    "\r\n" .
...
echo '">' .
    "\r\n" .
  '<i class="fa-solid fa-user text-lg mr-3 w-6"></i>' .
    "\r\n" .
    ...
    '                    href="./?page=user/list">' .
    "\r\n" .
   '<i class="fa-solid w-6 fa-users text-lg mr-3 w-6"></i>' .
    "\r\n" .
    '                    <span>Usuários</span>' .
    "\r\n" .
    '                  </a>' .
    ...
    '                    href="./?page=system_info">' .
    "\r\n" .
   '<i class="fa-solid  fa-gear text-lg mr-3 w-6"></i>' .
    "\r\n" .
    '                    <span>Configuração</span>' .
    "\r\n" .
    '                  </a>' .
...
echo '">' . "\r\n" . 
'<i class="fa-solid fa-left-from-bracket text-lg mr-3 w-6"></i>'
. "\r\n" . '         
									              <span>Log out</span>' . "\r\n" . '                  </a>' . "\r\n" . '                </li>' . "\r\n" . '              </ul>' . "\r\n" . '            </template>' . "\r\n" . '          </li>' . "\r\n" . '          </ul>' . "\r\n" . '        </div>' . "\r\n" . '      </header>';
